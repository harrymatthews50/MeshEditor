...
saveFileName ='/usr/local/micapollo01/MIC/DATA/STAFF/hmatth5/tmp/MeshEditor/demos/DemoData/DemoMeshDestination/demoFace1.obj' # what and where to save the output file
